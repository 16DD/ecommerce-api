...
class DiscountService {
    static async createDiscountCode(payload) {
        ...
        if (Date(start_date) >= new Date(end_date)) {
        ...
        const newDiscount = await discount.create({
            ...
            discount_type: type, // or percentage
            discount_code: code,
            ...
            discount_uses_count: uses_count, // number discount used
            discount_users_used: users_used,
            discount_max_uses_per_user: max_uses_per_user, // max use per user
            discount_min_order_value: min_order_value || 0,
            discount_shopId: shopId,
            discount_is_active: is_active,
            discount_applies_to: applies_to,
            discount_product_ids: applies_to === "all" ? [] : product_ids // number product apply
        });
    ...
    static async getDiscountAmount({ codeId, userId, shopId, products }) {
        const foundDiscount = await checkDiscountExists({
            model: discount,
            filter: { discount_code: codeId, discount_shopId: shopId }
        });
        ...
        //- Check min order value when apply discount
        let totalOrder = 0;
        ...
        //- Check discount  fix amount or percented
